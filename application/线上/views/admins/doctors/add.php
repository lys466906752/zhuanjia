...
<article class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c" id="show_a">
			  <td><font color='#cc0000'>*</font> 医生姓名：</td>
			  <td align="left" valign="middle"><input type="text" class="input-text" value="" placeholder="请填写医生的真实姓名" id="realname" name="realname"></td>
		  </tr>
			<tr class="text-c" style="display:none;">
			  <td><font color='#cc0000'>*</font> 所属分类：</td>
			  <td align="left" valign="middle">
			  	<input type="hidden" id="rooms" name="rooms" value="<?php echo $_COOKIE['webType'];?>">
			  </td>
		  </tr>
			<tr class="text-c">
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			else
			{
				...
				$.ajax({url:"<?php echo admin_url();?>doctors/inserts", 
				type: 'POST', 
				data:{realname:realname,show:displays,rooms:rooms}, 
				dataType: 'html', 
				timeout: 15000, 
					error: function(){
						layer.closeAll();
