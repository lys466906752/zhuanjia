...
<script>
	...
	function reads()
	{
		$.ajax({url:"<?php echo admin_url();?>admins/indexAjax/" + pageindex + "?keywords=" + keywords, 
			type: 'GET', 
			dataType: 'html', 
			timeout: 15000, 
			error: function(){
	...
	{
		location="<?php echo admin_url();?>admins/edit/" + id + ".html?pageindex=" + pageindex + "&keywords=" + keywords;	
	}
	...
	function del_rs(id){
		if(form_status==0 || form_status==3){
			$.ajax({url:"<?php echo admin_url();?>admins/del", 
			type: 'POST', 
			data:{id:id},
			dataType: 'html', 
			timeout: 15000, 
...
<div class="page-container">
	<div class="text-c"> 
    <input type="text" class="input-text" style="width:250px" placeholder="管理员用户名" id="keys" name="keys" value="<?php echo $keywords;?>">&nbsp;&nbsp;
