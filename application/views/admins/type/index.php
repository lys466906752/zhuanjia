...
<script>
	...
	function reads()
	{
		$.ajax({url:"<?php echo admin_url();?>type/indexAjax/" + pageindex + "?keywords=" + keywords, 
			type: 'GET', 
			dataType: 'html', 
			timeout: 15000, 
			error: function(){
	...
	{
		location="<?php echo admin_url();?>type/edit/" + id + ".html?pageindex=" + pageindex + "&keywords=" + keywords;	
	}
	...
	function del_rs(id){
		if(form_status==0 || form_status==3){
			$.ajax({url:"<?php echo admin_url();?>type/del", 
			type: 'POST', 
			data:{id:id},
			dataType: 'html', 
			timeout: 15000, 
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 分类管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="<?php echo admin_url();?>type/index" target="_blank" title="刷新" ><i class="Hui-iconfont">刷新</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
    <input type="text" class="input-text" style="width:250px" placeholder="分类名称" id="keys" name="keys" value="<?php echo $keywords;?>">&nbsp;&nbsp;
