...
<article class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c" id="show_a">
			  <td><font color='#cc0000'>*</font> 分类名称：</td>
			  <td align="left" valign="middle"><input type="text" class="input-text" value="<?php echo $res['name'];?>" placeholder="请填写分类名称" id="desc" name="desc"></td>
		  </tr>
			<tr class="text-c" >
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			else
			{
				...
				$.ajax({url:"<?php echo admin_url();?>type/updates/<?php echo $res['id'];?>", 
				type: 'POST', 
				data:{desc:desc}, 
				dataType: 'html', 
				timeout: 15000, 
					...
					success:function(result){
						...
						if(result.indexOf("|")>0){
							...
							if(arr[0]==100){
								...
								setTimeout("location='<?php echo admin_url();?>type/index.html?keywords=<?php echo $keywords;?>&pageindex=<?php echo $pageindex;?>'",1500);
							}else if(arr[0]==200){
