	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tbody>
			...
			<tr class="text-c" id="show_a">
			  <td><font color='#cc0000'>*</font> 管理员账号：</td>
			  <td align="left" valign="middle"><input type="text" class="input-text" value="" placeholder="请填写管理员账号，字母开头" id="username" name="username"></td>
		  </tr>
